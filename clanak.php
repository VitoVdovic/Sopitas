...
<?php
    ...
    if (isset($_GET['id'])) {
        ...
        echo "Nije specificiran ID članka.";
        exit; 
    }
?>
<html lang='hr'>
    ...
    <div class="container-fluid">
        ...
        <main style="width: 70%; margin: 20px auto;">
            <article class="clanak1">
                <h1><?php echo $clanak['naslov']; ?></h1>
                <div class="kategorijaV">
                    <p style="color: gray;"> <?php 
                        echo  $clanak['kategorija'] . " | " . date("d.m.Y", strtotime($clanak['datum']))  
                    ?> </p>
                </div>
                <div class="podnaslov">
                   <h2> <?php echo $clanak['sazetak']; ?> </h2>
                </div>
                <div class="clanak_slika" style="margin-bottom: 10px;">
                    <img src="data:image/jpeg;base64,<?php echo base64_encode($clanak['slika']); ?>" alt="Slika članka" width="80%">
                </div>
                <div class="clanak_sadrzaj">
